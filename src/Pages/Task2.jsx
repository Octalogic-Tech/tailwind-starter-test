function App() {
  return (
    <div className="p-16">
      ...
      <div className="m-10 flex flex-col w-2/3 shadow-lg">
        <blockquote className="overflow-hidden h-full bg-white">
          ...
          <footer className="px-6 py-4 space-x-4 text-white bg-gradient-to-br from-blue-700 to-blue-500 rounded-b-md">
